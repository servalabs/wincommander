    ...
    R: tokio::io::AsyncRead + Unpin,
{
    ...
    // Mount frames may contain the one-use password. Clear the raw inbound
    // bytes after decoding instead of leaving a second copy in allocator
    // memory until it is reused.
