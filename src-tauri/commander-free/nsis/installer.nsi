; Based on tauri-apps/tauri @tauri-apps/cli-v2.11.4, commit
...
Function PageReinstall
  ...
  Pop $R0
  ; An older NSIS uninstaller can delete shared Pro state before this setup's
  ; PREINSTALL hook runs. Skip its removal page and replace the app in place.
  ; WiX migration still follows its separate removal path below.
  ${If} $WixMode != 1
