    ...
    fn fleet_forensic_projection_keeps_a_bounded_full_detail_contract() {
        ...
        for category in FLEET_FORENSIC_PROJECTION_REGISTRY {
            ...
            assert!(
                category
                    .fleet_command_id
                    .starts_with("fleet.cleanup.inspect."),
...
pub(crate) const FLEET_FORENSIC_PROJECTION_REGISTRY: &[FleetForensicProjectionCategory] = &[
    ...
    cleanup_category!(
        ...
        "deep-dfir",
        "Get-ThumbnailCacheInfo"
    ),
    cleanup_category!(
        "notification_history",
        "Notification history",
        "deep-dfir",
        "Get-NotificationDatabaseInfo"
    ),
    cleanup_category!(
        "peer_distribution_cache",
        "Peer distribution cache",
        "deep-dfir",
        "Get-BranchCacheInfo"
    ),
    cleanup_category!(
        ...
        "deep-dfir",
        "Get-EventTranscriptInfo"
    ),
    cleanup_category!(
        "timeline_cache",
        "Timeline cache",
        "deep-dfir",
        "Get-ActivitiesTimelineInfo"
    ),
    cleanup_category!(
        "rdp_bitmap_cache",
        "RDP bitmap cache",
        "deep-dfir",
        "Get-RdpBitmapCacheInfo"
    ),
    cleanup_category!(
        "servicing_logs",
        "Servicing logs",
        "deep-dfir",
        "Get-ServicingLogsInfo"
    ),
    cleanup_category!(
        "device_install_logs",
        "Device installation logs",
        "deep-dfir",
        "Get-DeviceInstallLogsInfo"
    ),
    cleanup_category!(
        "usage_trace_logs",
        "Usage trace logs",
        "deep-dfir",
        "Get-UsageTraceLogsInfo"
    ),
    cleanup_category!(
        "protection_history",
        "Protection history",
        "deep-dfir",
        "Get-DefenderHistoryInfo"
    ),
    ...
    cleanup_category!(
        ...
        "Docker Desktop data",
        "deep-dfir",
        "Get-DockerDesktopDataInfo"
    ),
    cleanup_category!(
        "virtual_machine_artifacts",
        "Virtual machine artifacts",
        "deep-dfir",
        "Get-VirtualMachineArtifactsInfo"
    ),
    cleanup_category!(
        "developer_caches",
        "Developer caches",
        "deep-dfir",
        "Get-DeveloperCachesInfo"
    ),
    cleanup_category!(
        "credential_manager",
        "Credential Manager",
        "deep-dfir",
        "Get-CredentialManagerInfo"
    ),
    cleanup_category!(
        "network_wizard_history",
        "Network wizard history",
        "deep-dfir",
        "Get-NetworkWizardHistoryInfo"
    ),
    cleanup_category!(
        "wer_history",
    ...
    cleanup_category!(
        ...
        "Inactive-user protection metadata",
        "deep-dfir",
        "Get-InactiveUserProtectionMetadataInfo"
    ),
    cleanup_category!(
        "sticky_notes",
        "Sticky Notes",
    ...
    cleanup_category!(
        ...
        "OneDrive metadata",
        "deep-dfir",
        "Get-OneDriveMetadataInfo"
    ),
    cleanup_category!(
        "spotlight_cache",
        "Spotlight cache",
        "deep-dfir",
        "Get-SpotlightCacheInfo"
    ),
    ...
    cleanup_category!(
        ...
        "Legacy icon cache",
        "deep-dfir",
        "Get-LegacyIconCacheInfo"
    ),
    cleanup_category!(
        "game_captures",
        "Game captures",
        "deep-dfir",
        "Get-GameCapturesInfo"
    ),
    cleanup_category!(
        "photos_cache",
        "Photos cache",
    ...
    cleanup_category!(
        ...
        "deep-dfir",
        "Get-CommunicationCachesInfo"
    ),
    cleanup_category!(
        "editor_history",
        "Editor history",
        "deep-dfir",
        "Get-EditorHistoryInfo"
    ),
    cleanup_category!(
        "git_activity",
        "Git activity",
    ...
    cleanup_category!(
        ...
        "Remote access logs",
        "deep-dfir",
        "Get-RemoteAccessLogsInfo"
    ),
    cleanup_category!(
        "password_manager_caches",
        "Password-manager caches",
        "deep-dfir",
        "Get-PasswordManagerCachesInfo"
    ),
    cleanup_category!(
        "game_launcher_logs",
        "Game launcher logs",
        "deep-dfir",
        "Get-GameLauncherLogsInfo"
    ),
    cleanup_category!(
        "adobe_recent",
        "Adobe recent items",
    ...
    cleanup_category!(
        ...
        "Neighbor cache",
        "deep-dfir",
        "Get-NeighborCacheInfo"
    ),
    cleanup_category!(
        "netbios_cache",
        "NetBIOS cache",
        "deep-dfir",
        "Get-NetBIOSCacheInfo"
    ),
    cleanup_category!(
        "geolocation_cache",
        "Geolocation cache",
        "deep-dfir",
        "Get-GeolocationCacheInfo"
    ),
    cleanup_category!(
        "vpn_phonebooks",
        "VPN phonebooks",
        "deep-dfir",
        "Get-VPNPhonebooksInfo"
    ),
    cleanup_category!(
        "proxy_cache",
        "Proxy cache",
    ...
    cleanup_category!(
        ...
        "Cellular history",
        "deep-dfir",
        "Get-CellularHistoryInfo"
    ),
    cleanup_category!(
        "app_launch_history",
        "App launch history",
        "deep-dfir",
        "Get-AppLaunchHistoryInfo"
    ),
    ...
    cleanup_category!(
        ...
        "Embedded web cache",
        "deep-dfir",
        "Get-EmbeddedWebCacheInfo"
    ),
    cleanup_category!(
        "p2p_update_cache",
        "Peer update cache",
        "deep-dfir",
        "Get-P2PUpdateCacheInfo"
    ),
    cleanup_category!(
        "reliability_history",
        "Reliability history",
        "deep-dfir",
        "Get-ReliabilityHistoryInfo"
    ),
    cleanup_category!(
        "explorer_search_history",
        "Explorer search metadata",
        "deep-dfir",
        "Get-ExplorerSearchHistoryInfo"
    ),
    cleanup_category!(
        "search_personalization",
        "Search personalisation",
        "deep-dfir",
        "Get-SearchPersonalizationInfo"
    ),
    cleanup_category!(
        "process_review",
        "Process review",
...
pub(crate) async fn run_fleet_forensic_projection(
    ...
    let category_matches = result
        .get("category_id")
        .and_then(serde_json::Value::as_str)
        == Some(registry_entry.id);
    let label_matches =
        result.get("label").and_then(serde_json::Value::as_str) == Some(registry_entry.label);
    let is_structured = result
        .get("columns")
