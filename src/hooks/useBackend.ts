...
export interface CreateDualVolumeParams {
  ...
  Hash: string;
  Filesystem: string;
  InnerFilesystem?: string;
  OuterKeyfiles?: string[];
  InnerKeyfiles?: string[];
  OuterPim?: string;
  InnerPim?: string;
  ClusterSectors?: number;
  Device?: DeviceCreateTarget;
...
export interface DeviceCreateTarget {
  diskNumber: number;
  ...
  const backend = useMemo(() => ({
    ...
    createVolume: (params: CreateVolumeParams) =>
      execute("Create-EncryptionVolume", {
        ...
        Keyfiles: JSON.stringify(params.Keyfiles ?? (params.Keyfile ? [params.Keyfile] : [])),
        ...(params.Pim ? { Pim: params.Pim } : {}),
        ...(params.ClusterSectors ? { ClusterSectors: params.ClusterSectors } : {}),
        ...(params.Device ? {
          DeviceDiskNumber: params.Device.diskNumber,
          DevicePartitionNumber: params.Device.partitionNumber,
          DevicePartitionGuid: params.Device.partitionGuid,
          DeviceOffsetBytes: params.Device.offsetBytes,
    ...
    createDualVolume: (params: CreateDualVolumeParams) =>
      execute("Create-DualVolume", {
        ...
        Hash: params.Hash,
        Filesystem: params.Filesystem,
        OuterFilesystem: params.Filesystem,
        InnerFilesystem: params.InnerFilesystem ?? params.Filesystem,
        OuterKeyfiles: JSON.stringify(params.OuterKeyfiles ?? []),
        InnerKeyfiles: JSON.stringify(params.InnerKeyfiles ?? []),
        ...(params.OuterPim ? { OuterPim: params.OuterPim } : {}),
        ...(params.InnerPim ? { InnerPim: params.InnerPim } : {}),
        ...(params.ClusterSectors ? { ClusterSectors: params.ClusterSectors } : {}),
        ...(params.Device ? {
          DeviceDiskNumber: params.Device.diskNumber,
          DevicePartitionNumber: params.Device.partitionNumber,
    ...
    /** Opens a Windows event channel at its native Event Viewer location. */
    openEventLog: (logName: string) => execute("open_event_log", { logName }),
