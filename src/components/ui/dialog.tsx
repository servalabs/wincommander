    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="absolute right-4 top-4 inline-flex size-7 items-center justify-center rounded-[var(--r-sm)] text-[var(--text-dim)] transition-colors duration-150 hover:bg-[var(--surface-2)] hover:text-[var(--text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-line)] disabled:pointer-events-none"
        >
          <X className="size-4" />
