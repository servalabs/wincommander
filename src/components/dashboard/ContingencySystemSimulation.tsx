...
const initialFiles = [
  ...
  { id: 3, name: "Avengers_Endgame.mkv", sensitive: false, status: "safe" },
  { id: 4, name: "GTA_VI_Setup.exe", sensitive: false, status: "safe" },
];
        ...
        <div className="mt-8 pt-6">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-[11px] font-medium text-[var(--color-text-muted)]">
                      {folder.status === "erased" ? "Vaporized" : folder.sensitive ? "Encrypted" : "Standard"}
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="mt-4 rounded-lg bg-[var(--color-bg-tertiary)] p-3">
            <p className="text-[12px] uppercase leading-relaxed text-[var(--color-text-muted)] font-medium">
              <strong className="text-[var(--color-text-secondary)]">Explainer:</strong> This simulates an <span className="text-[var(--color-text-primary)] font-bold">Emergency Lockdown</span>.
              In a crisis, triggering the system physically or remotely <span className="text-red-600 font-bold">vaporizes sensitive data</span> from the active server while preserving a <span className="text-emerald-600 font-bold">secure offline backup</span> for authorized recovery.
            </p>
          </div>
        </div>
      </div>
