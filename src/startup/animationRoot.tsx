...
export function showStartupAnimation(props: StartupAnimationProps): void {
    ...
    if (!container) {
        ...
        // Styling is deliberately not observed as a readiness condition.
        // The browser applies it when available; a delayed or missing asset
        // must never block the application window from being shown.
