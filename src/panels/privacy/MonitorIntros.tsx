...
export function DecoyMonitorIntro({ isOpen, onClose }: IntroProps) {
    ...
    return (
        <IntroFrame
            ...
            body="Drop decoy files — fake passwords.txt, fake wallets, fake .docx — in places an intruder is most likely to look first. The system watches those exact paths. The moment anything reads or modifies one, your lockdown runs automatically. Real files stay untouched; the bait does the alerting."
            onClose={onClose}
        >
            <DecoyMonitorAnimation />
        </IntroFrame>
