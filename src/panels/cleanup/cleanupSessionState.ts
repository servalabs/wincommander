...
// KT: Cleanup tabs and panels unmount, so state must live outside component
// state to prevent navigation from silently triggering fresh work / losing
// the active tab.
export function useCleanupSessionState<T>(
  key: string,
  initialValue: T,
