...
export default function CleanupCategoryGrid({
  ...
  const orderUnscannedFirst = (categories: CleanupCategory[]) =>
  ...
  // confirmed empty category immediately leaves the working grid and is
  // packed four-at-a-time into the next available card slot.
  const activeSysCats = orderUnscannedFirst(
