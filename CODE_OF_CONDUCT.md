...
We as members, contributors, and maintainers of WinCommander pledge to
...
pull requests, discussions, chat) and also applies when an individual
...
may be reported to the maintainers at **conduct@servalabs.com**.
...
1. **Correction** — private warning for unprofessional conduct
2. **Warning** — public warning + cooldown on community interaction
3. **Temporary Ban** — temporary ban from any kind of community
   interaction
4. **Permanent Ban** — permanent ban from any kind of public
